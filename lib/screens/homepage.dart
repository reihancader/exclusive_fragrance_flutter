...
class _HomePageState extends State<HomePage> {
  ...
  final List<Product> fetchedProducts = data.map((json) => Product.fromJson(json)).toList();
  if (mounted) {
    setState(() {
      bestSellerProducts = fetchedProducts.where((product) => product.isBestSeller).toList();
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  // Header with Search
                  Padding(
                    padding: EdgeInsets.fromLTRB(0, MediaQuery.of(context).padding.top + 20, 0, 0),
                    child: Row(
